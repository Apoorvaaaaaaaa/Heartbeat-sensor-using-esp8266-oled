...
long myChannelNumber = 2899453;

const char myWriteAPIKey[] = "JMG6K1XRICX5ZKM9";
...
void setup (void)
  ...
  { display.begin(SSD1306_SWITCHCAPVCC, 0x3C);
    ...
    WiFi.begin("Redmi Note 9 Pro", "priyammrani");
...
void loop ()
  ...
  { starttime = millis();
    ...
    ThingSpeak.writeField(2899453, 1, heartrate, myWriteAPIKey);
